...
translations.en.liName = 'Associate Researcher Xiaoqiang Li';
translations.en.yangRole = 'Assistant Professor and Master’s Supervisor, School of Computer Engineering and Science';
translations.en.newsText = 'Congratulations! Two papers from our lab have been accepted to EMNLP 2026.';
translations.en.newsPaperLabel = 'PAPER ACCEPTANCE';
translations.en.newsRecruitLabel = 'OPEN POSITIONS';
translations.en.newsRecruitText = 'We welcome undergraduate, master’s, PhD and research interns working on foundation models, agents and AI security.';
translations.en.newsRecruitLink = 'View open positions →';
...
function setLanguage(lang){
  ...
  document.title = lang === 'zh' ? '通用智能与安全可信实验室 · 上海大学' : 'SAGE Lab · Shanghai University';
